...
import { HiOutlineShieldCheck, HiOutlineClock } from "react-icons/hi2";
...
export default function ContactSection() {
  ...
  const waLink = useMemo(() => whatsAppHref(waMessage), [waMessage]);
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-[var(--bg-alt)] px-6 py-28">
      <div
        className="pointer-events-none absolute -left-32 top-1/4 h-96 w-96 rounded-full bg-[var(--whatsapp-soft)] blur-[100px]"
        aria-hidden
      />
      <div
      ...
      <div className="relative mx-auto max-w-6xl">
        <SectionHeader
          ...
          subtitle="Message us for availability — same channel as the best local hires: fast, clear, and mobile-first."
        />
          ...
          <motion.div variants={item} className="lg:col-span-5">
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--surface)]/80 p-8 shadow-[var(--shadow-card)] backdrop-blur-md">
              <p className="font-display text-2xl font-semibold italic leading-snug text-[var(--fg)]">
                Bookings &amp; questions — <span className="text-[var(--whatsapp)]">WhatsApp only</span>.
              </p>
                ...
                {[
                  {
                    Icon: FaWhatsapp,
                    title: "Instant chat",
                    text: "Share dates, pickup preference, and scooter tier in one thread.",
                  },
                  {
                    Icon: TbScooter,
                    title: "Fleet & rates",
                  ...
                  <li key={title} className="flex gap-4">
                    <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[var(--whatsapp-soft)] text-[var(--whatsapp)]">
          ...
          <motion.div variants={item} className="lg:col-span-7">
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-[var(--shadow-card)] md:p-10">
              <div className="flex flex-wrap items-end justify-between gap-4 border-b border-[var(--border)] pb-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-[var(--fg-muted)]">
                    Adjust options — your message updates automatically for WhatsApp.
                  </p>
                </div>
                <span className="rounded-full bg-[var(--whatsapp-soft)] px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[var(--whatsapp)]">
                  Live preview
                </span>
              </div>
              ...
              <div className="mt-8 flex flex-col gap-5">
                <div className="grid gap-5 sm:grid-cols-2">
                  <label className="block">
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-[var(--border)] bg-[var(--surface-elevated)] px-4 py-3 text-sm text-[var(--fg)] transition-shadow focus:border-[var(--whatsapp)] focus:outline-none focus:ring-2 focus:ring-[var(--whatsapp)]/30"
                    >
                ...
                <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface-elevated)] px-4 py-3.5 transition-colors hover:border-[var(--whatsapp)]/30">
                  <input
                    type="checkbox"
                    name="wantsDelivery"
                    checked={state.wantsDelivery}
                    onChange={handleChange}
                    className="mt-0.5 h-4 w-4 rounded border-[var(--border)] text-[var(--whatsapp)] focus:ring-[var(--whatsapp)]/40"
                  />
                  ...
                  {!quote.valid ? (
                    ...
                    <ul className="mt-3 space-y-2 text-sm text-[var(--fg-muted)]">
                      ...
                      <li className="mt-3 flex justify-between gap-4 border-t border-[var(--border)] pt-3 font-semibold text-[var(--fg)]">
                        ...
                        <span className="font-display text-lg italic text-[var(--whatsapp)]">
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-xl border border-[var(--border)] bg-[var(--surface-elevated)] px-4 py-3 text-sm text-[var(--fg)] placeholder:text-[var(--fg-subtle)] transition-shadow focus:border-[var(--whatsapp)] focus:outline-none focus:ring-2 focus:ring-[var(--whatsapp)]/30"
                  />
                </label>
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.99 }}
                  className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-[var(--whatsapp)] px-6 py-4 text-base font-semibold text-[var(--whatsapp-fg)] shadow-lg shadow-[var(--whatsapp)]/25 transition-shadow hover:bg-[var(--whatsapp-hover)] hover:shadow-xl hover:shadow-[var(--whatsapp)]/30"
                >
                  ...
                  <FaWhatsapp className="relative h-6 w-6 shrink-0" aria-hidden />
                  <span className="relative">Message us on WhatsApp</span>
                </motion.a>

                <p className="text-center text-xs text-[var(--fg-subtle)]">
                  Opens WhatsApp with your hire details pre-filled — edit before sending if you like.
                </p>
              </div>
            </div>
          </motion.div>
