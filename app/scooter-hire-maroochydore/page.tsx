...
const location = LOCATIONS.maroochydore;

export const metadata: Metadata = {
  metadataBase: new URL("https://honkhireco.com.au"),
  title: location.metaTitle,
  description: location.metaDescription,
  alternates: { canonical: "/scooter-hire-maroochydore" },
  openGraph: {
    title: location.metaTitle,
    description: location.metaDescription,
    url: "https://honkhireco.com.au/scooter-hire-maroochydore",
...
const localBusinessSchema = buildLocalBusinessSchema([
  "Maroochydore", "Alexandra Headland", "Cotton Tree",
]);
...
const schema = {
  ...
  areaServed: { "@type": "City", name: "Maroochydore" },
  serviceType: "Scooter Hire",
  url: "https://honkhireco.com.au/scooter-hire-maroochydore",
};

export default function MaroochydorePage() {
  return (
    <>
      <script
